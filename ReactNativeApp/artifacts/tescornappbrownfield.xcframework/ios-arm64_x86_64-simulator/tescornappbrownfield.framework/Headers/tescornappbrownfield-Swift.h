...
#ifndef TESCORNAPPBROWNFIELD_SWIFT_H
#define TESCORNAPPBROWNFIELD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="tescornappbrownfield",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20tescornappbrownfield25ExpoBrownfieldAppDelegate")
...
@class NSCoder;
@class NSBundle;
SWIFT_CLASS("_TtC20tescornappbrownfield25ReactNativeViewController")
